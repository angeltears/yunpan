 ...
 */
/* -------------------------------------------*/
MYSQL* msql_conn(char *user_name, char* passwd, char *db_name,char *ip, unsigned int port)
{
	...
	//passwd: 参数包含用户的密码
	if ( mysql_real_connect(conn, ip, user_name, passwd, db_name, port, NULL, 0) == NULL)
	{
